...
cor_pre <- bind_cols(cor_pre_slope, cor_pre_hr)
...
# mean slope 
cor.test(cor_pre$slope, cor_pre$teaching_experience)
cor.test(cor_pre$slope, cor_pre$disruption_factor_m)
cor.test(cor_pre$slope, cor_pre$confidence_factor_m)
...
fix_models %>% 
  ...
  select(slope) -> cor_teaching_slope
...
cor_teaching <- bind_cols(cor_teaching_slope, cor_teaching_hr)
...
# slope ~
cor.test(cor_teaching$slope, cor_teaching$teaching_experience)
cor.test(cor_teaching$slope, cor_teaching$disruption_factor_m)
cor.test(cor_teaching$slope, cor_teaching$confidence_factor_m)
...
cor_post <- bind_cols(cor_post_slope, cor_post_hr)
...
# slope ~
cor.test(cor_post$slope, cor_post$teaching_experience)
cor.test(cor_post$slope, cor_post$disruption_factor_m)
cor.test(cor_post$slope, cor_post$confidence_factor_m)
...
fix_models %>% 
  ...
  select(slope) -> cor_interview_slope
...
cor_interview <- bind_cols(cor_interview_slope, cor_interview_hr)
...
# slope ~
cor.test(cor_interview$slope, cor_interview$teaching_experience)
cor.test(cor_interview$slope, cor_interview$disruption_factor_m)
cor.test(cor_interview$slope, cor_interview$confidence_factor_m)
...
cor_end <- bind_cols(cor_end_slope, cor_end_hr)
...
# slope ~
cor.test(cor_end$slope, cor_end$teaching_experience)
cor.test(cor_end$slope, cor_end$disruption_factor_m)
cor.test(cor_end$slope, cor_end$confidence_factor_m)
