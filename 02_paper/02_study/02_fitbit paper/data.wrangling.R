...
#         file = "data/dilation.rds")
# 
# saveRDS(object = df_dil_aggr,
#         file = "data/dilation_aggr.rds"
#         )
# 
# rm(list = ls())
...
# 
# df_dil_aggr <- read_rds(file = "data/dilation_aggr.rds")
# 
