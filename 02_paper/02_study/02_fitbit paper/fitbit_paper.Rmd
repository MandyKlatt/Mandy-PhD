...
df_demo$term <- as.numeric(df_demo$term)

# changing `extracurricular_teaching_experience to count experience (no experience = 2 --> 0)
df_demo$extracurricular_teaching_experience = ifelse(demo.data$extracurricular_teaching_experience == 1, "1","0")

# changing character extracurricular_teaching_experience into numeric
df_demo$extracurricular_teaching_experience <- as.numeric(df_demo$extracurricular_teaching_experience)

# changing secondary_teaching_activities to count experience (no experience = 2 --> 0)
df_demo$secondary_teaching_activities = ifelse(df_demo$secondary_teaching_activities == 1, "1","0")

# changing character Extra. Exp. into numeric
df_demo$secondary_teaching_activities <- as.numeric(df_demo$secondary_teaching_activities)
...
The sample consisted of *N* = `r length(df_demo$ID)` participants with *n* = `r length(df_demo$ID[df_demo$ID == "Expert"])` expert teachers and *n* = `r length(demo.data$ID[demo.data$ID == "Novice"])` novice teachers. 
