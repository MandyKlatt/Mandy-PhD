...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1\textwidth]{appendix_figure1.png}
  ...
  \label{Laboratory setting of the micro-teaching unit.}
\end{figure}
```
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1\textwidth]{appendix_figure2.png}
  ...
  \label{Laboratory setting of the interview.}
\end{figure}
```
