...
address:
  - code: Leipzig University
    organization: Division of Empirical School and Classroom Research, Institute of Educational Sciences
  ...
  - code: University of Greifswald
    organization: Division of Health and Prevention, Institute of Psychology
...
[^5]: Although this procedure does not account for nonmonotonic progressions in individual HR, a graphical evaluation revealed that the linear estimates corresponded well to the majority of the cases (see Figures \ref{fig.a3} to \ref{fig.a7} in the supplementary material).
...
\begin{table}[h]
    \centering
    \caption{\\
    Correlations between mean standardized HR/mean slopes and the predictor variables of teaching experience, disruption appraisal, and confidence appraisal for the five intervals.}
