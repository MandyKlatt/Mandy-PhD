...
author:
  - name: Mandy Klatt
    ...
    footnote: 1
  - name: Peer Keßler
    email: peer.kessler@uni-greifswald.de.com
...
\end{table}
 \footnotetext[9]{Please note that standardized \textit{M} and \textit{SD} of the overall course were not exactly 0 and 1 due to rounding differences.}
 \footnotetext[10]{Deviations of the minimum values in the overall course vs. the end interval ($I_5$) are due to data of a few participants who needed more than two hours to finish the study.}
...
\captionof{table}{\\
Standardized regression coefficients of mean standardized heart rate and mean slopes predicted by teaching experience, disruption appraisal, and confidence appraisal for the five intervals.}
...
\begin{table}[ht]
    ...
    \begin{tabularx}{\textwidth}{XXX}
        \toprule
        \textbf{Verbal disruptions} & \textbf{Physical disruptions} & \textbf{Lack of eagerness to learn} \\
        \midrule
...
\begin{figure}[htbp]
  \centering
  \caption{\\
  Laboratory setting of the micro-teaching unit. Note. The setting included three actors as the class (left) and a teacher (participant, right).}
...
\begin{figure}[htbp]
  \centering\caption{\\
  Laboratory setting of the interview. Note. The experimenter and participant watched the previously taught micro-teaching unit on video.}
