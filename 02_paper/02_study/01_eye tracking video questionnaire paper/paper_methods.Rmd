...
```
XXX FRANZI
```{r item_analysis_classroom_management_novice, echo=FALSE, include=FALSE, results='asis'}
quest.data %>%
...
```{r item_analysis_classroom_management_expert, echo=FALSE, include=FALSE, results='asis'}
quest.data %>%
  dplyr::filter(Group == "Expert") %>% 
  dplyr::select(contains("LM")) %>%
  as.data.frame() %>%
  tab_itemscale(CSS = list(
    css.firsttablerow.col7 = "'cronbachs alpha';"
...
```{r item_analysis_balance_novice, echo=FALSE, include=FALSE, results='asis'}
quest.data %>%
  dplyr::filter(Group == "Novice") %>% 
...
```{r item_analysis_balance_expert, echo=FALSE, include=FALSE, results='asis'}
quest.data %>%
  dplyr::filter(Group == "Expert") %>%
  dplyr::select(contains("LB")) %>%
  as.data.frame() %>%
...
```{r item_analysis_presence_novice, echo=FALSE, include=FALSE,results='asis'}
quest.data %>%
  dplyr::filter(Group == "Novice") %>%
...
```{r item_analysis_presence_expert, echo=FALSE, include=FALSE,results='asis'}
quest.data %>%
  dplyr::filter(Group == "Expert") %>%
  dplyr::select(contains("LP")) %>%
  as.data.frame() %>%
...
```{r item_analysis_behavior_novice, echo=FALSE, include=FALSE,results='asis'}
quest.data %>%
  dplyr::filter(Group == "Novice") %>%
...
```{r item_analysis_behavior_expert, echo=FALSE, include=FALSE,results='asis'}
quest.data %>%
  dplyr::filter(Group == "Expert") %>%
  dplyr::select(contains("LV")) %>%
  as.data.frame() %>%
