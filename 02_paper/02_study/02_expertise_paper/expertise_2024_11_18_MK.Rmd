...
# # Prepare annotation data for labels
# annotation_data <- category_stats_with_tests %>%
#   left_join(y_max_by_category, by = "Disruption_Category") %>%
#   mutate(
#     novice_label = paste0("italic(M) == ", M_Novice, " ~ ", "italic(SD) == ", SD_Novice),
#     expert_label = paste0("italic(M) == ", M_Expert, " ~ ", "italic(SD) == ", SD_Expert),
#     overall_label = paste0("italic(p) == ", p_value, " ~ ", "italic(d) == ", cohen_d)
#   )
...
# +
#   # Annotate novice statistics
#   geom_text(
#     data = annotation_data,
#     aes(x = 1, y = y_max, label = novice_label),
#     inherit.aes = FALSE,
#     parse = TRUE, size = 3.5, hjust = 0.5, vjust = 0
#   ) +
#   # Annotate expert statistics
#   geom_text(
#     data = annotation_data,
#     aes(x = 2, y = y_max, label = expert_label),
#     inherit.aes = FALSE,
#     parse = TRUE, size = 3.5, hjust = 0.5, vjust = 0
#   ) +
...
#   geom_text(
#     data = annotation_data,
#     aes(x = 1.5, y = y_max * 1.05, label = overall_label),
#     inherit.aes = FALSE,
#     parse = TRUE, size = 4, fontface = "italic", hjust = 0.5, vjust = 0
#   )
...
# Post-hoc comparisons for Disruption_Category
  ...
  post_hoc_results$contrast <- gsub("_", " ", post_hoc_results$contrast) # Replace underscores with spaces
  post_hoc_results$contrast <- gsub("\\.", " ", post_hoc_results$contrast) # Replace dots with spaces
