...
output: 
  pdf_document:
    ...
    latex_engine: xelatex  # Specify LaTeX engine if needed
    keep_tex: true      # Keep .tex file for debugging or customization
---
...
#### 2.2.2 Number of fixations per minute (AOI others)
