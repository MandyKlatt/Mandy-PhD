...
ggplot(df_aoi_sum_expert, aes(x = "", y = Number_fixation_min_mtu)) + 
  ...
  labs(title = "Boxplot of number of fixations per minute (micro-teaching unit)",
...
# Calculate the IQR and bounds
Q1 <- quantile(df_aoi_sum_novice$Number_fixation_min_mtu, 0.25)
Q3 <- quantile(df_aoi_sum_novice$Number_fixation_min_mtu, 0.75)
IQR <- Q3 - Q1
...
# Filter to remove outliers
df_no_outliers_mtu_nov <- df_aoi_sum_novice %>%
  filter(Number_fixation_min_mtu >= LowerBound & Number_fixation_min_mtu <= UpperBound)

# Check the number of rows before and after filtering
nrow(df_aoi_sum_novice)  # Original data
nrow(df_no_outliers_mtu_nov)  # After removing outliers
...
ggplot(df_aoi_stud_expert, aes(x = "", y = Stud_number_fixation_min)) + 
  geom_boxplot(outlier.color = "red", outlier.shape = 19, outlier.size = 3) +
  labs(title = "Boxplot of number of fixations per minute (AOI students)",
       y = "Number of fixations per minute") +
  theme_minimal()
...
ggplot(df_aoi_disrup_expert, aes(x = "", y = Number_of_fixations.Disruptive_Person)) + 
  geom_boxplot(outlier.color = "red", outlier.shape = 19, outlier.size = 3) +
  labs(title = "Boxplot of number of fixations per minute (AOI disruptive person)",
       y = "Number of fixations per minute") +
  theme_minimal()
...
ggplot(df_aoi_disrup_expert, aes(x = "", y = Average_duration_disrup)) + 
  geom_boxplot(outlier.color = "red", outlier.shape = 19, outlier.size = 3) +
  labs(title = "Boxplot of average duration of fixations (AOI disruptive person)",
       y = "Average duration of fixations") +
  theme_minimal()
...
# GRI = Average_duration_mtu / Sum_number_fixation
...
ggplot(df_gri_expert, aes(x = "", y = Average_duration_mtu)) + 
  geom_boxplot(outlier.color = "red", outlier.shape = 19, outlier.size = 3) +
  labs(title = "EXPERT: Boxplot average duration (mtu)",
...
ggplot(df_gri_expert, aes(x = "", y = Sum_number_fixation)) + 
  geom_boxplot(outlier.color = "red", outlier.shape = 19, outlier.size = 3) +
  labs(title = "EXPERT: Boxplot of summarized number of fixations (mtu)",
       y = "Mean duration of fixations/\nmean number of fixations") +
  theme_minimal()
...
ggplot(df_gri_novice, aes(x = "", y = Average_duration_mtu)) + 
  geom_boxplot(outlier.color = "red", outlier.shape = 19, outlier.size = 3) +
  labs(title = "NOVICE: Boxplot average duration (mtu)",
       y = "Mean duration of fixations/\nmean number of fixations") +
  theme_minimal()
...
ggplot(df_gri_novice, aes(x = "", y = Sum_number_fixation)) + 
  geom_boxplot(outlier.color = "red", outlier.shape = 19, outlier.size = 3) +
  labs(title = "NOVICE: Boxplot of summarized number of fixations (mtu)",
       y = "Mean duration of fixations/\nmean number of fixations") +
  theme_minimal()
...
#### MANAGING MOMENTUM #### 
# t-test for expertise differences 
t.test(x = df_sjt_mean$`Managing momentum`[df_sjt_mean$Group == "Expert"],
       y = df_sjt_mean$`Managing momentum`[df_sjt_mean$Group == "Novice"],
       var.equal = TRUE
       )


# effect size for expertise differences
d_sjt_mm <- CohenD(x = df_sjt_mean$`Managing momentum`[df_sjt_mean$Group == "Expert"],
                   y = df_sjt_mean$`Managing momentum`[df_sjt_mean$Group == "Novice"],
                   na.rm = TRUE
                  )
...
#### MONITORING ####
# t-test for expertise differences 
t.test(x = df_sjt_mean$Monitoring[df_sjt_mean$Group == "Expert"],
       y = df_sjt_mean$Monitoring[df_sjt_mean$Group == "Novice"],
       var.equal = TRUE
       )


# effect size for expertise differences
d_sjt_moni <- CohenD(x = df_sjt_mean$Monitoring[df_sjt_mean$Group == "Expert"],
                     y = df_sjt_mean$Monitoring[df_sjt_mean$Group == "Novice"],
                     na.rm = TRUE
                    )
...
#### RULES & ROUTINES #### 
# t-test for expertise differences 
t.test(x = df_sjt_mean$`Rules and routines`[df_sjt_mean$Group == "Expert"],
       y = df_sjt_mean$`Rules and routines`[df_sjt_mean$Group == "Novice"],
       var.equal = TRUE
      )


# effect size for expertise differences
d_sjt_rr <- CohenD(x = df_sjt_mean$`Rules and routines`[df_sjt_mean$Group == "Expert"],
                   y = df_sjt_mean$`Rules and routines`[df_sjt_mean$Group == "Novice"],
                   na.rm = TRUE
                  )
