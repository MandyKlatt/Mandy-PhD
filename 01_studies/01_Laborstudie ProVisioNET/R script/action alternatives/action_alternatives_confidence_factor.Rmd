...
# novices: correlation between confidence factor and non-disruptive alternatives (absolute score)
nov_confi_abs.nd_corr <- cor.test(corr.nov$confidence_factor,
                              corr.nov$nd, 
                              method=c("pearson"),
                              adjust="holm")
print(nov_confi_abs.nd_corr, 
      short = F)

# experts: correlation between confidence factor and non-disruptive alternatives (absolute score)
exp_confi_abs.nd_corr <- cor.test(corr.exp$confidence_factor,
                              corr.exp$nd, 
                              method=c("pearson"),
                              adjust="holm")
print(exp_confi_abs.nd_corr,
      short = F)

# full sample: correlation between confidence factor and non-disruptive alternatives (absolute score)
full_confi_abs.nd_corr <- corr.test(main$confidence_factor, 
                                main$nd, method=c("pearson"),
                                adjust="holm")
print(full_confi_abs.nd_corr,
      short = F)  


###################################################

# novices: correlation between confidence factor and non-disruptive alternatives (relative score)
...
# experts: correlation between confidence factor and non-disruptive alternatives (relative score)
...
# full sample: correlation between confidence factor and non-disruptive alternatives (relative score)
